...
class Moderator(Base, TimestampMixin):
    ...
    jurisdiction_state: Mapped[str | None] = mapped_column(String(100), nullable=True)
    jurisdiction_district: Mapped[str | None] = mapped_column(String(100), nullable=True)
    pocso_cert_number: Mapped[str | None] = mapped_column(String(100), nullable=True)
